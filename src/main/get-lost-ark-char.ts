...
// import { Auth } from '../renderer/recoil/user.state';
...
//         /https:\/\/cdn-lostark.game.onstove.com\/2018\/obt\/assets\/imag
// es\/common\/thumb\/.*?alt=".*?">.*?<\/span>/g,
//       );
...
//       //#region 전투 레벨 파싱
//       const charLevelInfo =
//         /전투 레벨<\/span><span><small>Lv.<\/small>(.*?)</g.exec(str);
...
//       //#region 직업 아이콘, 직업 파싱
//       const JobIconAndJobName =
//         /profile-character-info__img" src="(.*?)" alt="(.*?)">/g.exec(str);
